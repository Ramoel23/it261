...
<h1><a href="index.php">Leo's Portal Page</a></h1>
<h2>The navigation below represents our big assiment </h2>
<div id="wrapper">
<nav>
<ul>
...
<main>
    <h2>About Leo</h2>
        ...
        <img  src="images/wamp.png" alt="wamp">

        <img  src="images/wamp_error.png" alt="error">
...
<footer>
    <ul>
       ...
       <li><a href="../index.php">Web Design by Leo Aparra</a></li>
